...
class ParishDocumentWindow:
    ...
    def _createUIEelements(self):
        ...
        ctk.CTkLabel(self.buttonFrame, text="Документ прихода", font=("Helvetica", 30)).pack(side="left", padx=10, pady=10)
        ctk.CTkLabel(self.buttonFrame, text=" " * 12, font=("Helvetica", 30)).pack(side="left", padx=10, pady=10)
        self.buttonCreateItem = ctk.CTkButton(self.buttonFrame, text="Создать товар", font=("Helvetica", 30))
    ...
    def create_table(self):
        self.tree = ttk.Treeview(self.tableFrame, columns=("Number", "Conter", "NumberTel", "Name", "Description", "Type", "Quantity", "Price", "Creation Date"))
