...
class StorageWindow:
    ...
    def _createUIEelements(self):
        ...
        ctk.CTkLabel(self.buttonFrame, text=" " * 35, font=("Helvetica", 30)).pack(side="left", padx=10, pady=10)
    ...
    def create_table(self):
        self.tree = ttk.Treeview(self.tableFrame, columns=("Number", "Conter", "NumberTel", "Name", "Description", "Type", "Quantity", "Price", "Creation Date", "Modification Date"))
        for header, option in Constants.STORAGE_WINDOW_TREE_OPTIONS.items():
